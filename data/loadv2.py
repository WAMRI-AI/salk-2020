...
def get_data(data_pth, lr_dir, hr_dir, bs, in_sz, out_sz, norm_stats=([0.485, 0.229]), valid=True,
             valid_pct=0.2, num_workers=4, noise=None, max_zoom=1.1):
    src = get_src(data_pth, lr_dir, hr_dir, valid, valid_pct)
    ...
    data = (src
            ...
            .normalize(norm_stats, do_y=True))
    data.c = 1
    return data

def get_data_rgb(data_pth, lr_dir, hr_dir, bs, in_sz, out_sz,
...
def get_patched_data(data_pth, hr_dir, bs, in_sz, out_sz, norm_stats,
                     tfms=None, num_workers=4, noise=None, max_zoom=1.):
...
def get_patched_src(data_pth, hr_dir, seed=49):
    ...
    src = (ImageImageList
            .from_folder(hr_tifs, convert_mode='L')
...
def get_src(data_pth, lr_dir, hr_dir, valid=True, valid_pct=0.2, seed=49):
    hr_tifs = data_pth/f'{hr_dir}'
    ...
    if valid:
        src = (ImageImageList
                .from_folder(lr_tifs, convert_mode="L")
